			...
			<div id="contents">
				<div class="box">
					<div>
                        ...
                        <form id="form2" name="form2" method="post" action="rcreg.php" style="margin:auto;">
                            ...
                            <table>
									...
									<td></td>
										...
										<tr>
											<td> Mobile Number:</td>
											<td>
											 <input type="text" name="mnum" value="<?php if ((isset($mnum))&&($mnumErr==false)){echo $mnum;}?> " class="txtfield" />
			  ...
			  ?>
                      ...
                      <span style="color:red; font-family:Times New Roman; font-size:12px;"></span>
                                	...
                                	<span style="color:red; font-family:Times New Roman; font-size:12px;"></span><a href="offers.php">Show Offers</a>
										 ...
										 <tr>
											<td></td>
											<td>
											<input name="next" id="next" type="submit" value="Next" class="btn" />
						...
						<h2>Recharge Hub</h2>
							<p><img src="banner.jpg" alt="Img"></p>	
						</div>
					</div>
				</div>
			</div>
